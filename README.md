...
> The sample images are used only to illustrate model behavior.  
> Any resemblance to real individuals is coincidental, and no malicious intent is associated with their use.
